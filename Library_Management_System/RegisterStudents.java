...
public class RegisterStudents extends javax.swing.JFrame {
       ...
       try {
           ...
           Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/library_management_system","root","gupta22@");
             ...
             while(rs.next()){
                 ...
                 Object[] obj = {id, name,password,email, contact,course,branch};
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 20, 360, -1));
        ...
        tbl_issuBookDetails.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Name", "Password", "Email", "Contact No.", "Course", "Branch"
            }
        ));
        ...
        jPanel1.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 130, 420, 4));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 54, 1090, 660));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 0, 50, 50));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1360, 55));
    ...
    private void jLabel271MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel271MouseExited
       jPanel269.setBackground(mouseExitColor);        // TODO add your handling code here:
